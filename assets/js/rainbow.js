/* Rainbow v2.1.4 rainbowco.de | included languages: css, generic, html, javascript */ !(function (e, t) {
        ...
        return function (r) {
            (e.innerHTML = r.result),
                ...
                "PRE" === e.parentNode.tagName &&
                    (e.parentNode.classList.remove("loading"), e.parentNode.classList.add("rainbow-show")),
                M && M(e, r.lang),
                0 === --t.c && n();
        };
    }
    ...
    function b(e, t) {
        ...
        for (
            var n = e.getElementsByTagName("pre"), r = e.getElementsByTagName("code"), a = [], o = [], i = 0, s = n;
            i < s.length;
            i += 1
        ) {
            var u = s[i];
            h(u),
                u.getElementsByTagName("code").length
                    ? u.getAttribute("data-trimmed") ||
                      (u.setAttribute("data-trimmed", !0), (u.innerHTML = u.innerHTML.trim()))
                    : a.push(u);
        }
    ...
    var M,
        Prism = function Prism(e) {
            function t(e, t) {
                for (var n in h)
                    if (((n = parseInt(n, 10)), r(n, h[n], e, t) && (delete h[n], delete p[n]), i(n, h[n], e, t)))
                        return !0;
                return !1;
            }
            function n(t, n) {
...
Rainbow.extend("css", [
    ...
    Rainbow.extend("html", [
        ...
        {
            matches: { 1: "support.operator", 2: "string.quote", 3: "string.value", 4: "string.quote" },
            pattern: /(=)('|")(.*?)(\2)/g,
        },
    ...
    Rainbow.extend(
        ...
        [
            ...
            { matches: { 1: "support.function" }, pattern: /(setTimeout|setInterval)(?=\()/g },
            {
                ...
                pattern:
                    /\.(getAttribute|replace|push|getElementById|getElementsByClassName|setTimeout|setInterval)(?=\()/g,
            },
            {
                name: "string.regexp",
                matches: {
            ...
            { matches: { 1: "keyword", 2: "variable.type" }, pattern: /(new)\s+(?!Promise)([^\(]*)(?=\()/g },
            ...
            { matches: { 1: "storage.type.accessor", 2: "entity.name.function" }, pattern: /(get|set)\s+(\w+)(?=\()/g },
            { matches: { 2: "entity.name.function" }, pattern: /(^\s*)(\w+)(?=\([^\)]*?\)\s*\{)/gm },
            {
                matches: {
