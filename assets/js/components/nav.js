...
<div class="md-nav-menu">
    <button class="close-nav" type="button" id="close-nav" tippy="close">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
        </svg>
    </button>
    <div class="md-logo-container">
        <a class="hyperlink" href="" data-location="home" tippy="home">
...
<div class="nav-container">
    <a class="logo-container hyperlink" href="" data-location="home" tippy="home">
    ...
    <div class="nav-btn-wrapper">
        <a class="nav-btn hyperlink" href="" data-location="sign_up" tippy="signUp"> Get Started </a>
    </div>
