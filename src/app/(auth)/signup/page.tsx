				...
				>
					...
					<div className='flex justify-between my-4 mx-0'>
						<div className='mx-auto'>
							<Link
								href=''
								className='text-sm dark:text-neutral-300 no-underline hover:underline dark:hover:text-neutral-50'
							>
								By signing up, you agree to our term of use.
							</Link>
						</div>
					</div>
					<button
					...
					<div className='flex justify-center items-center gap-2 dark:text-neutral-300 text-sm mt-4'>
						<span className='dark:text-neutral-300 text-sm'>Already have an account? </span>
						<Link
