...
extendedDesc: CSS provides powerful properties for styling and customizing lists in web pages. Whether you are creating unordered list with bullet points or ordered list with numbers or letters, CSS offers a range of options to control thier appearance and behavior.
---
...
- **decimal-leading-zero** (01, 02, 03...)
  ...
  ### Output:
  <MDXImage 
    src='/images/lesson-images/l4/decimal-leading-zero.png'
